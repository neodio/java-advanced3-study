...
public class OptionalProcessingMain {
    ...
    public static void main(String[] args) {
        ...
        // 값이 있으면 Function 적용 후 Optional로 변환, 없으면 Optional.empty()
        ...
        // map()과 유사하나, 이미 Optinal을 반환하는 경우 중첩을 제거
        ...
        Optional<String> flatOpt = optValue.flatMap(s -> Optional.of(s));
        System.out.println("optValue = " + optValue);
        ...
        // 값이 없으므로 실행 안 됨
        optEmpty.stream().forEach(s -> System.out.println("optValue.optEmpty() -> " + s));
    }
}
